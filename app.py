...
# 3. Model Setup (ඔයාගේ ලිස්ට් එකේ තිබුණු අලුත්ම මොඩල් එක)
try:
    # අපි භාවිතා කරන්නේ 'gemini-2.5-flash'
...
if "messages" not in st.session_state:
    ...
    st.session_state.messages.append({"role": "model", "content": "ආයුබෝවන්! මම කපුටා (Kaputa). අලුත්ම Gemini 2.5 මොළයත් එක්ක මම ආවා. මොනවද දැනගන්න ඕන?"})
